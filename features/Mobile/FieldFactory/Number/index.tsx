/**
 * Number Field - Mobile optimized number input
 * Field Type: DOUBLE
 ...
 *
 * Special behavior:
 * - Only allows numeric input (type="number")
 * - "123" icon displayed on the LEFT side
 * - No spinner buttons shown
 * - Numeric keyboard on mobile devices
 * - Same styling as Text/Paragraph fields (border, not box shadow)
 */
...
export const NumberField = ({ field, value: propValue, onChange }: NumberFieldProps) => {
  const [value, setValue] = useState<number | string>(propValue || '');
