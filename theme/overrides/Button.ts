    ...
    MuiButton: {
      ...
      styleOverrides: {
        root: {
          ...
          boxShadow: designTokens.effects.shadows.button,
          textTransform: 'none',
          '&::after': {
            content: '""',
            display: 'block',
        ...
        sizeSmall: {
          padding: designTokens.button.padding.small,
        },
        sizeMedium: {
          padding: designTokens.button.padding.medium,
        },
        sizeLarge: {
          padding: designTokens.button.padding.large,
        },
      },
    },
  };
